...
import com.eccomerce.com.liked.halanan_towarlar_activity;
        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+ Api.url+"ygty/get_liked_items.php");
                    Log.d("url",""+url);
                    ...
                    if (sb.toString().length()>20)GetJson(sb.toString());//idlar gelyar tazelemeli
                ...
                try{//bashda data basadan hemme informasiyasyny alyas
                    ...
                    for(int i=0; i<jsonArray.length();i++) {
                        ...
                        m.setEamil(data.optString("email"));
                            constants.likeditems.add(m);
                            constants.idfd.add(data.optString("id"));
                        }}
                    constants.iter=true;
                    halanan_towarlar_activity.s1.sendEmptyMessage(1);
