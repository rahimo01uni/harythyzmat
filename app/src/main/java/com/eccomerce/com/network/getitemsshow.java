        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+ Api.url+"ygty/get_showdetails.php");
                    Log.d("url",""+url);
                ...
                try{//bashda data basadan hemme informasiyasyny alyas
                    ...
                    for(int i=0; i<jsonArray.length();i++) {
                        ...
                        m.setEamil(data.optString("email"));
                            constants.showitem.add(m);
                            constants.shopimg=data.optString("shopimage");
                        constants.shopname=data.optString("shopname");
                   }
          show_details.s1.sendEmptyMessage(1);
