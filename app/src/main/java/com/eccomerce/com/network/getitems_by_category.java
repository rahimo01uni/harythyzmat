...
import com.eccomerce.com.categories.all;
...
public class getitems_by_category {
        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+ Api.url+"ygty/getitemsct.php");
                    Log.d("url",""+url);
                    ...
                    String post_data = URLEncoder.encode("category", "UTF-8") + "=" + URLEncoder.encode(constants.category, "UTF-8")
                            ...
                            + "&"+URLEncoder.encode("size", "UTF-8") + "=" + URLEncoder.encode(""+ constants.size, "UTF-8") +  "&"+URLEncoder.encode("name", "UTF-8") + "=" + URLEncoder.encode(""+ constants.name,"UTF-8");
