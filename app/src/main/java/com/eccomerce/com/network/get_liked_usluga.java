...
import com.eccomerce.com.liked.halanan_usluga_activity;
        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+ Api.url+"ygty/get_liked_usluga.php");
                    Log.d("url",""+url);
                    ...
                    for(int i=0; i<jsonArray.length();i++) {
                        JSONObject data = jsonArray.getJSONObject(i);
                            ...
                            m=new model_ulg(data.optString("id"),
                                    ...
                                    data.optString("numberede"));
                            m.setImg5("image5");
                            m.setMg6("image6");
                            constants.likedusluga.add(m);

                    }
                    halanan_usluga_activity.s1.sendEmptyMessage(1);
