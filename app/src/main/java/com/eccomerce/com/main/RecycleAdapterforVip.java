...
public class RecycleAdapterforVip extends RecyclerView.Adapter<RecycleAdapterforVip.Reklama_viewholder> {
    ...
    public class Reklama_viewholder extends RecyclerView.ViewHolder {
        TextView title, price,price1, ratenumber, manat, count_number, time,discount,rate_uslug;
...
//            Typeface tp= Typeface.createFromAsset(cntx.getAssets(),"font/font10.ttf");
    ...
    public RecycleAdapterforVip(ArrayList<modelvip> items, Context ctx) {
        this.list1 = items;
        this.cntx = ctx;
    }
...
*/
    ...
    /*
        Glide.with(cntx)
                ...
                .load(R.drawable.towarlar1).thumbnail(0.01f).diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(holder.image);
        */

        Log.e("image",list1.get(position).getImage());
