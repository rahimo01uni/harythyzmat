...
public class RecycleAdapterforsearch extends RecyclerView.Adapter<RecycleAdapterforsearch.Reklama_viewholder> {
    ...
    public RecycleAdapterforsearch(ArrayList<modelvip> items, Context ctx) {
        this.list1 = items;
        this.cntx = ctx;
