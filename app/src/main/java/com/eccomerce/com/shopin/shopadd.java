...
public class shopadd extends AppCompatActivity {
    ...
    static public EditText editText_sene,email_edit,ulanjy_edit,password_edit,bildiris_edit,dushindirsh_edit,yeri_edit;
    TextView ulanjy,email,password,bildisady,surat_txt,spinner_yeri,
            dushindirish,name2,number2,surat_gosh,yeri_txt;
    ...
    String   name1,number1,content1,username1,password1,email1,yeri1;
    Button add;
    ImageView backimg;
   RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_lenta1);
        ...
        surat_gosh=findViewById(R.id.textView_surat_gos);
        surat_gosh.setText(Dil.surat_gos);
        content=(EditText)findViewById(R.id.content);
        number=(EditText)findViewById(R.id.nomer);
        number2 = findViewById(R.id.nomer2);
        number2.setText(Dil.nomer);
        name2=findViewById(R.id.title_magazin);
        name2.setText(Dil.magazin_ady);
        name.setHint(Dil.magazin_hint);
        yeri_txt=findViewById(R.id.yeri_txt);
        yeri_edit=findViewById(R.id.yeri_edit);
yeri_txt.setText(Dil.yerlesyan_yeri);
yeri_edit.setHint(Dil.yeri_hint);

number.setHint(Dil.nomer_hint);

       final ProgressDialog progressDialog=new ProgressDialog(this);

        dushindirish=findViewById(R.id.lenta_dusundirisi_title_bil_gos);
        dushindirish.setText(Dil.maglumat2);
        dushindirsh_edit=findViewById(R.id.content);
        dushindirsh_edit.setHint(Dil.dus_hint);

        email_edit=findViewById(R.id.email_edit);
        email_edit.setHint(Dil.email_hint);
        ulanjy_edit=findViewById(R.id.username_edit);
        ulanjy_edit.setHint(Dil.ulnjy_hint);
        password_edit=findViewById(R.id.password_edit);
        password_edit.setHint(Dil.pass_hint);

        email=findViewById(R.id.email);
        email.setText("Email");
        ulanjy=findViewById(R.id.username);
        ulanjy.setText(Dil.ulnjy_ady);
        password=findViewById(R.id.password);
        password.setText(Dil.password);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                username1=ulanjy_edit.getText().toString();
                email1=email_edit.getText().toString();
                password1=password_edit.getText().toString();
                yeri1 = yeri_edit.getText().toString();
                if(number1.equals("")&&name1.equals("")&&content1.equals("")&&username1.equals("")&&email1.equals("")&&yeri1.equals("")&&password1.equals("")){
                    Toast.makeText(shopadd.this,Dil.hemmesini_doldur,Toast.LENGTH_LONG).show();
                }
                else{
                ...
                Toast.makeText(shopadd.this,Dil.magazin_goshulyar,Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        @Override
     public void onClick(View view) {
               Intent intent = new Intent(shopadd.this, AlbumSelectActivity.class);
        ...
        s2=new Handler(){
            @Override
            public void handleMessage(Message msg) {
        Toast.makeText(shopadd.this,Dil.magazin_gushuldy,Toast.LENGTH_SHORT).show();
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    object.put("username", username1);
                    object.put("password", password1);
                    object.put("email",email1);
                    object.put("loction",yeri1);
...
//                    a.setData(listView_surat);
                    ...
                    URL url=new URL("http://"+ Api.url+"ygty/insert_shop.php");
                    Log.d("url",""+url);
