...
public class viewpager_adapter_usluga extends PagerAdapter {
    private LayoutInflater inflater;
    ArrayList<String> images;
    private Context context;
   String table;
    public viewpager_adapter_usluga(Context context, ArrayList<String> images) {
       ...
       Glide.with(context)
        ...
        myImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context.getApplicationContext(),reklam_photo_usluga.class));
